        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center max-w-2xl mx-auto mb-10 md:mb-16">
            ...
            <p className="text-muted-foreground">
              Powerful AI tools designed to give you an edge in the competitive
              job market.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Detailed keyword analysis and semantic matching to ensure your resume passes any ATS screening.",
                icon: <Zap className="h-6 w-6 text-primary" />,
              },
              {
                title: "Cold Email Generator",
                description:
                  "Create highly personalized outreach emails for recruiters and hiring managers in seconds.",
                icon: <Mail className="h-6 w-6 text-primary" />,
              },
              {
                title: "Smart Resume Analysis",
                description:
                  "Get actionable feedback on your resume structure, impact, and phrasing with AI-driven scores.",
                icon: <FileText className="h-6 w-6 text-primary" />,
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="rounded-none border bg-card p-8 transition-colors hover:bg-muted/30"
              >
      ...
      <section id="pricing" className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="max-w-2xl mb-10">
            ...
            <p className="text-muted-foreground">
              Start free while resume parsing, tracking, and billing mature into
              paid plans.
            </p>
          </div>
            ...
            {[
              {
                name: "Free",
                price: "$0",
                detail: "Resume upload and parsing foundation",
              },
              {
                name: "Pro",
                price: "Soon",
                detail: "ATS analysis, cold emails, and usage credits",
              },
              {
                name: "Teams",
                price: "Soon",
                detail: "Shared workspaces, billing, and collaboration",
              },
            ].map((plan) => (
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.8fr_1fr]">
          <div>
            ...
            <p className="text-muted-foreground leading-7">
              Rescomail is structured as a SaaS from the start: authenticated
              users, protected resume storage, parser services, and a
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div
                key={item}
                className="border bg-background p-4 text-sm font-medium"
              >
                {item}
              </div>
            ))}
      ...
      <footer className="border-t py-12">
        <div className="mx-auto flex max-w-7xl flex-col gap-10 px-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-8 text-sm font-medium text-muted-foreground">
            ...
            <Link
              href="mailto:support@rescomail.com"
